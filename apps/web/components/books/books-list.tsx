    ...
    <>
      <div className="mb-4">
        <input
          ...
          className="w-full max-w-sm rounded-lg border border-zinc-300 px-3 py-2 text-sm text-zinc-900 focus:outline-none focus:ring-2 focus:ring-zinc-500"
        />
      </div>
      ...
      {filtered.length === 0 ? (
        ...
        <ul className="divide-y divide-zinc-100 rounded-xl border border-zinc-200 bg-white">
          {filtered.map((book) => (
            <li key={book.id}>
              <div className="flex items-center justify-between px-5 py-4 hover:bg-zinc-50">
                <Link
                  href={`/books/${book.id}`}
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    {book.authors && (
                      <p className="truncate text-sm text-zinc-500">{book.authors}</p>
                    )}
                  </div>
                </Link>
