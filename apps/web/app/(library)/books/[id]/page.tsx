        ...
        <div className="mb-4 flex items-start justify-between gap-4">
          ...
          <div className="flex gap-2 shrink-0">
            ...
            <Link
              ...
              className="rounded-lg border border-zinc-300 px-4 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-50 dark:border-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-950"
            >
              Edit
            </Link>
